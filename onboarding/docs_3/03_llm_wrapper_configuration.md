...
class ModelType(Enum):
    ...
    RESEARCH = "gpt-5"  # Fast, cost-effective for research
    CONVERSATION = "o1-mini"    # High quality for user interactions
    ANALYSIS = "gpt-5"   # Balanced for analysis tasks
    SUMMARY = "gpt-5"         # High quality for final summaries
